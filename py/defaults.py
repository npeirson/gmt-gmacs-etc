...
default_exposure_time_step = 1
default_seeing = 0.5
default_seeing_start = 0.1
default_seeing_end = 2.0
...
default_read_noise = 2
default_limits_wavelength = [3200,10360]
default_start_wavelength = 3200
default_stop_wavelength = 10360
default_wavelength_step = 20
...
default_resolution = [3.73/3,3.73] #[res/bins] # low, high angstr/resolution element [3.73,bins] []
default_plot_step_step=default_resolution[0]
#default_wavelength = arange(default_start_wavelength,default_stop_wavelength,default_plot_step_step)
default_wavelength = arange(3200,10360,3.73/3.)
