...
dichroic_path = 'data/dichroic.txt'
grating_path = ['data/efficiencies/grating_red_low_res.txt','data/efficiencies/grating_blue_low_res.txt']
ccd_path = ['data/efficiencies/e2v_red.txt','data/efficiencies/e2v_blue.txt']
...
skyfiles = ['00d.txt','03d.txt','07d.txt','10d.txt','14d.txt']
